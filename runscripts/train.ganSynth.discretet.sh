...
MODEL="2021-02-01.pianobrass.iendpoints.vars.discretet" #"2021-01-24_pianobrass" #"PoissonModalBar1_16k" #must match directory name of pset
OUTDIR=${MODEL}".tfr.4_.$(date +%Y%m%d)"
