...
#CPDIR='scratch/i1.arpeggio.npy'

#CPDIR='scratch/rhapsody_1000samps.npy'

#CPDIR='scratch/responseiveness_i0.arpeggio_then_glide.npy'
CPDIR='scratch/responseiveness_inst_step_then_glide.npy'
...
#AUDIO_OUT="output/${OUTDIR}/audio/rhapsody.H256.FTR.99.SL256." #${c}."
AUDIO_OUT="output/${OUTDIR}/audio/responseiveness_inst_step_then_glide.3secs." #${c}."
AUDIO_OUT+=$STEP
