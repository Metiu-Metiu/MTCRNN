...
PROP="rate"
MODEL="PoissonModalBar1fast_16k" #"PoissonModalBar1_16k" #must match directory name of pset
OUTDIR=$MODEL".$(date +%Y%m%d)"

#################   For continuing from checkpoint
CHECKPOINTDIR="output/PoissonModalBar1fast_16k.20200603/model" #make sure different than OUTDIR otherwise will overwrite
CHECKPOINTSTEP="8000"
