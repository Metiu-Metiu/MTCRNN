...
PROP="instID pitch"
MODEL="2021-02-06_normed_brass.flute_endpoints.20vars.steadystate" #"2021-01-24_pianobrass" #"PoissonModalBar1_16k" #must match directory name of pset
OUTDIR=${MODEL}"_steadystate_.20210206" #$(date +%Y%m%d)"


#################   For continuing from checkpoint
CHECKPOINTDIR="output/2021-02-06_normed_brass.flute_endpoints.20vars.steadystate_steadystate_.20210206/model" #make sure different than OUTDIR otherwise will overwrite
