 #!/bin/bash
PROP="rate"
MODEL="PoissonGeiger68_16k" # "ffx_geiger1_16k" #must match directory name of pset
OUTDIR="PoissonGeiger68fast_16k.20200604" #"PoissonGeiger68_16k.20200603" # $MODEL".$(date +%Y%m%d)_temp" # $MODEL".$(date +%Y%m%d)" # created by train, "geigertier1"
