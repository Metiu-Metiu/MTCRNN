...
MODEL="2021-01-28_pianobrass_sf16_copy" #"2021-01-24_pianobrass" #"PoissonModalBar1_16k" #must match directory name of pset
OUTDIR=${MODEL}".tfr.9_.$(date +%Y%m%d)"


#################   For continuing from checkpoint
CHECKPOINTDIR="output/2021-01-28_pianobrass_sf16_copy.tfr.9_.20210130/model" #make sure different than OUTDIR otherwise will overwrite
CHECKPOINTSTEP="3000"
